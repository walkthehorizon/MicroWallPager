 ...
 * @time: 16/8/24
 */
public class PictureLoadingView extends View {

    private final String TAG = PictureLoadingView.class.getSimpleName();
    ...
    public PictureLoadingView(Context context) {
        this(context, null);
    }

    public PictureLoadingView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PictureLoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
