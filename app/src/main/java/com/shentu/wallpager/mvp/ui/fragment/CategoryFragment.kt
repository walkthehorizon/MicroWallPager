...
import com.shentu.wallpager.mvp.di.component.DaggerCategoryComponent
import com.shentu.wallpager.mvp.presenter.CategoryPresenter
import com.shentu.wallpager.mvp.ui.adapter.CategoryAdapter
...
class CategoryFragment : BaseFragment<CategoryPresenter>(), CategoryContract.View {
    ...
    override fun initData(savedInstanceState: Bundle?) {
        rv_category.layoutManager = GridLayoutManager(context, 3)
    }
