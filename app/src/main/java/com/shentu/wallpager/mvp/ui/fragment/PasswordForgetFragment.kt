...
import com.shentu.wallpager.di.component.DaggerPasswordForgetComponent
...
import com.shentu.wallpager.mvp.presenter.PasswordForgetPresenter
 ...
 * }
 */
class PasswordForgetFragment : BaseFragment<PasswordForgetPresenter>(), PasswordForgetContract.View {
    companion object {
        fun newInstance(): PasswordForgetFragment {
            val fragment = PasswordForgetFragment()
            return fragment
        }
    }
    ...
    override fun setupFragmentComponent(appComponent: AppComponent) {
        DaggerPasswordForgetComponent //如找不到该类,请编译一下项目
                ...
                .passwordForgetModule(PasswordForgetModule(this))
                .build()
                .inject(this)
    }
