...
class SplashActivity : BaseActivity<IPresenter>() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        setTheme(com.shentu.wallpaper.R.style.AppTheme)
        ScreenUtils.setFullScreen(this)
        super.onCreate(savedInstanceState)
    }

    override fun initView(savedInstanceState: Bundle?): Int {
        return com.shentu.wallpaper.R.layout.app_activity_splash
    }
    ...
    private fun showSplash() {
        supportFragmentManager
                .beginTransaction()
                .replace(com.shentu.wallpaper.R.id.container, SplashFragment.newInstance(), SplashFragment::class.java.simpleName)
                .commit()
    }
